<main>
  ...
  if ($lang == '2') {
    echo '<h1 class="page-header container text-capitalize left-padding">EDIT DATA PROTECTION</h1>';
  }
  else {
    echo '<h1 class="page-header container text-capitalize left-padding">EDIT DATENSCHUTZ</h1>';
  }
