<main class="about-us-page">
  ...
  <form enctype="multipart/form-data" role="form" action="" method="post">
    ...
    <div class="about-us-right-image container box-mid-margin left-padding">
      ...
      <div class="container box-mid-margin">
        <label for="name">Page name</label>
        <input id="name" type="text" name="name"
               value="<?php echo $data['add']['name']; ?>">
      ...
      <div class="row">
        ...
        <div class="about-us-image col-xs-7">
          ...
          <input type="file" class="form-control" id="mission_img"
                 name="mission_img"
        ...
        <div class="about-us-text col-xs-5">
          ...
          <textarea name="mission_text"
                    class="editor-area"><?php echo $data['add']['mission_text']; ?></textarea>
        </div>
      </div>
    </div>
    ...
    <div class="about-us-left-image container box-mid-margin left-padding">
      <div class="row">
        <div class="about-us-image  col-xs-7">
          ...
          <input type="file" class="form-control" id="vision_img"
                 name="vision_img"
        ...
        <div class="about-us-text  col-xs-5">
          ...
          <textarea name="vision_text"
                    class="editor-area"><?php echo $data['add']['vision_text']; ?></textarea>
        </div>
      </div>

      <div
          class="about-us-description-wrapper about-us-description-edit box-mid-margin container ">
        <div class="about-us-description">
          <h4 class=""><?php echo $data['add']['name']; ?></h4>
          <textarea name="about_us_description"
                    class="editor-area"><?php echo $data['add']['about_us_description']; ?></textarea>
        </div>
      </div>
